    ...
    bot.ev.on('connection.update', async (update) => {
        ...
        if (connection === 'close') {
            ...
            bot.sendMessage(bot.user.id, {
                text: `*hi bro! 🫡*\n_ᴍᴜʟᴛɪʙᴏᴛ x v2 bot has successfully connected to the server_`
            });
        }
    });
