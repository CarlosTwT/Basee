...
const { gssrentbot } = require("./RentBot.js");
...
const { addPremiumUser, getPremiumPosition } = require("./lib/premiun.js");
 ...
 *Upload Date:* ${uploadDate}
 ...
 └────────────`;
    ...
    case "autoread":
     ...
     if (args[0] === "on") {
      ...
      gss.sendPoll(m.chat, "Please Choose, I Hope You're Happy!", [
    ...
    case "alwaysonline":
     ...
     break;
     async function archiveChat(message) {
      try {
       const lstMsg = {
 ...
 ╰────────────────❃ `;
     ...
     let cmdList = cmdGrup
      .sort((a, b) => a.localeCompare(b))
      .map((v, i) => `${randomSymbol}┃${convertToFontStyle(prefix + v, randomFontStyle)}`)
      .join("\n");
